...
shinyUI(fluidPage(
  ...
  tabsetPanel(
    ...
    tabPanel("EPA Measures Map", br(),
             ...
             plotOutput("kbarPlot", height="400px", width="700px"), 
             hr(),
             ...
             div(style="display: inline-block;",tags$a(imageOutput("POImage",height="200px"),href="https://localadventurer.com/wp-content/uploads/2017/08/things-to-do-in-portland-bucket-list.jpg",target="_blank")),
             br(), br()),
